...
(function(mag) {
  ...
  var clone = function(obj) {
    if (null == obj || typeof object == 'undefined' || 'object' != typeof obj) {
      return obj;
    }
    ...
    try {
      ...
      try {
        ...
        try {
          ...
          Object.prototype.__defineSetter__.call(obj, propName, function(
            value
          ) {
            setter.call(this, value, true); // coalesce changes
          });
      ...
      if (isArr) {
        ...
        watchFunctions(obj, function(index, action, newValue, oldValue) {
          ...
          if (
            level !== 0 &&
            newValue &&
            (isObject(newValue) || isArray(newValue))
          ) {
            var i,
              n,
              ln,
